...
// Our interpreter module, which executes the AST generated by the parser.
// A few differences from the original Java implementation:
//         - We use Rust's enums to represent the different types of expressions and statements. No
//         need for a visitor pattern.
